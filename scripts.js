...
const objPrincipal = {
    ...
    // criacao dinamica do resumo
    retornarTemplateResumo: function (id_template) {
        return { id: id_template, template: "html->", autoheight: true }
    },
    ...
    visualisarDados: function (dados, pNomeDivDestino, pTitulo) {
        ...
        for (const [propriedade, valores] of Object.entries(dados)) {
            ...
            html += `<h4 style="margin-bottom: 0;margin-top: 0;font-family: PT Sans">Valores acumulados(   ${pTitulo} )</h4>`;
    ...
    fncCarregar: async function (callback) {
        const self = this;
